...
<template>
	<aside
		class="bg-white z-20 drop-shadow-xl text-sidebar-color min-h-[100vh] max-h-[100vh] w-3/4 md:w-[15vw] md:block fixed left-0 top-0 transition-transform duration-300 transform"
		:class="{
