...
<template>
	<LayoutDefault v-slot="slotProps">
		...
		<div class="min-h-[80vh] flex flex-row bg-gray-100">
			<main class="w-full bg-content-bg flex flex-col gap-6">
				<div
				...
				<div
					class="overflow-auto rounded-lg shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]"
				>
					<h1 class="text-xl p-6 font-medium bg-white">User List</h1>
					<TableUser
						:userData="userData"
